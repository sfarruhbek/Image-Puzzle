...
namespace WindowsFormsApplication1
{
    public partial class frmPuzzleGame : Form
    {
        ...
        private void btnShuffle_Click(object sender, EventArgs e)
        {
            ...
            {
                YesOrNo = MessageBox.Show("Qaytadan boshlamoqchimisz ?", "Rabbit Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            }
        ...
        {
            DialogResult YesOrNO = MessageBox.Show("Chiqishni istaysizmi ?", "Rabbit Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void UpdateTimeElapsed(object sender, EventArgs e)
        {
            ...
            if (timer.Elapsed.Minutes.ToString() == "1")
            {
                ...
                inmoves = 0;
                btnPause.Enabled = false;
                MessageBox.Show("Vaqt tugadi\nQaytadan urining", "Rabbit Puzzle");
                Shuffle();
            }
        }
